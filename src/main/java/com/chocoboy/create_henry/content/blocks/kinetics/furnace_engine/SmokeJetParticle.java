...
public class SmokeJetParticle extends SimpleAnimatedParticle {
    ...
    public static class Factory implements ParticleProvider<SmokeJetParticleData> {
        ...
        public Particle createParticle(SmokeJetParticleData data, ClientLevel worldIn, double x, double y, double z,
                                       double xSpeed, double ySpeed, double zSpeed) {
            return new SmokeJetParticle(worldIn, data, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
}