...
public class FurnaceEngineInstance extends BlockEntityInstance<FurnaceEngineBlockEntity> implements DynamicInstance {
    ...
    public FurnaceEngineInstance(MaterialManager materialManager, FurnaceEngineBlockEntity blockEntity) {
        ...
        this.piston = materialManager.defaultSolid().material(Materials.TRANSFORMED).getModel(HenryPartialModels.ENGINE_PISTON, this.blockState).createInstance();
        this.linkage = materialManager.defaultSolid().material(Materials.TRANSFORMED).getModel(HenryPartialModels.ENGINE_LINKAGE, this.blockState).createInstance();
        this.connector = materialManager.defaultSolid().material(Materials.TRANSFORMED).getModel(HenryPartialModels.ENGINE_CONNECTOR, this.blockState).createInstance();
    }
