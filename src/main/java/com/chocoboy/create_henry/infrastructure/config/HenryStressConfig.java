...
public class HenryStressConfig extends ConfigBase {
	...
	public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
		return builder -> {
			...
			ResourceLocation id = HenryCreate.asResource(builder.getName());
	...
	private static void assertFromCreate(BlockBuilder<?, ?> builder) {
		if (!builder.getOwner().getModid().equals(HenryCreate.MOD_ID)) {
			throw new IllegalStateException("Non-Create: Henry blocks cannot be added to Create: Henry's config.");
		}
	}
